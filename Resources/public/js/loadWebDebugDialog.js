function Domis86WebDebugDialogLoaderClass() {
    ...
    function loadLibs() {
        ...
        yepnope({
            ...
            nope: [dataContainer.data('jquery-ui_url_1'), dataContainer.data('jquery-ui_url_2')],
            complete: function () {
        ...
        yepnope({
            ...
            nope: [dataContainer.data('datatables_url_1'), dataContainer.data('datatables_url_2')],
            complete: function () {
